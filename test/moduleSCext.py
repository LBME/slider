...
CAposC = (-0.000 , -0.000 ,  0.000)
CposC  = ( 0.002 ,  1.445 , -0.518)
NposC  = (-0.001 ,  0.001 ,  1.496)

CAposModel = (20.479 , 19.415 , -37.955)
CposModel  = (21.238 , 19.782 , -36.708)
NposModel  = (21.413 , 19.090 , -39.010)


P = np.array([CAposC, CposC, NposC])
Q = np.array([CAposModel, CposModel, NposModel])
...
Ptrans = P - centroid(P)
Qtrans = Q - centroid(Q)
print('centroid(Ptrans)',centroid(Ptrans))
print('centroid(Qtrans)',centroid(Qtrans))
...
#print("U", U)
print('P rotated',teste)
print('Q reference\n',Qtrans)
print ('teste\n',teste)
teste2 = teste + centroid(Q)
print ('teste2\n',teste2)
...
C  =( 0.002 ,  1.445 , -0.518)
O  =( 0.873 ,  1.839 , -1.295)
CB =(-1.209 , -0.763 , -0.546)
CG =(-1.241 , -2.232 , -0.157)
CD =(-0.089 , -3.049 , -0.720)
NE =(-0.077 , -3.048 , -2.180)
CZ =(-0.825 , -3.842 , -2.931)
NH1=(-1.655 , -4.708 , -2.364)
NH2=(-0.749 , -3.773 , -4.254)

ARG=np.array([N,CA,C,O,CB,CG,CD,NE,CZ,NH1,NH2])

ARG2=ARG-centroid(P)
ARG3=np.dot(ARG2, U)
ARG4=ARG3+centroid(Q)
print ('ARG4\n',ARG4)
